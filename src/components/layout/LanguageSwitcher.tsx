...
export function LanguageSwitcher() {
  ...
  return (
    <>
      ...
      {/* Language modal — portalled to body so it's not constrained by header layout */}
            ...
            {open && (
              ...
              >
                ...
                <motion.div
                  ...
                  aria-modal="true"
                  aria-label={t("title")}
                  className="relative w-full max-w-2xl max-h-[80dvh] bg-white rounded-2xl shadow-2xl shadow-bordeaux-900/25 flex flex-col overflow-hidden"
                >
                  {/* Header */}
